; ModuleID = 'matrix_copy_shared.cu'
...
@.str = private unnamed_addr constant [13 x i8] c"copy_out.txt\00", align 1
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_matrix_copy_shared.cu, i8* null }]
...
define dso_local void @_Z4copyPfPKf(float* %odata, float* %idata) #3 {
entry:
  ...
  %call = call i32 @cudaLaunchKernel(i8* bitcast (void (float*, float*)* @_Z4copyPfPKf to i8*), i64 %10, i32 %12, i64 %16, i32 %18, i8** %kernel_args, i64 %5, %struct.CUstream_st* %19)
  br label %setup.end
...
invoke.cont:                                      ; preds = %for.end16
  invoke void @_ZNSt14basic_ofstreamIcSt11char_traitsIcEE4openEPKcSt13_Ios_Openmode(%"class.std::basic_ofstream"* %outfile, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i32 %call17)
...
kcall.configok:                                   ; preds = %invoke.cont58
  ...
  invoke void @_Z4copyPfPKf(float* %58, float* %59)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_matrix_copy_shared.cu() #0 section ".text.startup" {
entry:
