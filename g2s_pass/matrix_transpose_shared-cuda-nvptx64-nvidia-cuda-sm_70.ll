; ModuleID = 'matrix_transpose_shared.cu'
source_filename = "matrix_transpose_shared.cu"
...
@_ZZ9transposePfPKfE4tile = internal addrspace(3) global [32 x [32 x float]] undef, align 4
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx14 = getelementptr inbounds [32 x [32 x float]], [32 x [32 x float]]* addrspacecast ([32 x [32 x float]] addrspace(3)* @_ZZ9transposePfPKfE4tile to [32 x [32 x float]]*), i64 0, i64 %idxprom13
  %14 = call i32 @llvm.nvvm.read.ptx.sreg.tid.x() #3, !range !11
  %idxprom16 = zext i32 %14 to i64
  %arrayidx17 = getelementptr inbounds [32 x float], [32 x float]* %arrayidx14, i64 0, i64 %idxprom16
...
for.body22:                                       ; preds = %for.cond20
  %17 = call i32 @llvm.nvvm.read.ptx.sreg.tid.x() #3, !range !11
  %idxprom24 = zext i32 %17 to i64
  %arrayidx25 = getelementptr inbounds [32 x [32 x float]], [32 x [32 x float]]* addrspacecast ([32 x [32 x float]] addrspace(3)* @_ZZ9transposePfPKfE4tile to [32 x [32 x float]]*), i64 0, i64 %idxprom24
  %18 = call i32 @llvm.nvvm.read.ptx.sreg.tid.y() #3, !range !11
  %19 = load i32, i32* %j19, align 4
  %add27 = add i32 %18, %19
  %idxprom28 = zext i32 %add27 to i64
  %arrayidx29 = getelementptr inbounds [32 x float], [32 x float]* %arrayidx25, i64 0, i64 %idxprom28
